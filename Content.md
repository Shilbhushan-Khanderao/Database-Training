...
(3, 'Raj', 'Shinde', '2007-03-15', 'MG Road, Nagpur', 'raj.shinde@example.com'),
...
#### CREATE TABLE Students with UNIQUE Email and Primary Key
...
#### ALTER TABLE Enrollments with CHECK CONSTRAINT

```sql
ALTER TABLE Enrollments
ADD CONSTRAINT CHECK (grade BETWEEN 0 AND 4.0);
```
...
SELECT FirstName, LastName
FROM Students
WHERE Address LIKE '%Road%' AND DateOfBirth > '2005-01-01';
```
...
SELECT FirstName, LastName
FROM Students
WHERE Address LIKE '%Pune%' OR Address LIKE '%Nashik%';
```
